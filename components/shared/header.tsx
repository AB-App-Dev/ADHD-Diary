          ...
          {dropdownOpen && (
            <div className="absolute right-0 mt-2 w-48 rounded-lg border border-border bg-surface py-1 shadow-lg">
              ...
              <Link
                ...
                className="flex items-center gap-2 px-4 py-2 text-sm text-foreground hover:bg-background"
              >
              ...
              <button
                ...
                className="flex w-full items-center gap-2 px-4 py-2 text-left text-sm text-foreground hover:bg-background"
              >
                <svg className="h-4 w-4 text-muted" fill="none" stroke="currentColor" viewBox="0 0 24 24">
